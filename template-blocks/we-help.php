<section id="we-help" class="we-help">
  <div class="container">
    ...
    <p><a href="#" class="show-cf-498">Чек-лист. Основные стили интерьеров</a></p>
    <p><a href="#" class="show-cf-499">Чек-лист. Топ 10 ошибок в чертежах</a></p>
    <p><a href="#" class="show-cf-500">Чек-лист. Ошибки при ремонте</a></p>

    <div class="modal-fade cf-498">
       <div class="modal__holder">
        <div class="modal-popup">
           <div class="modal__container">
                <h2 class="client__header client__header--modal">Чек-лист.<br>Основные стили интерьеров</h2>
